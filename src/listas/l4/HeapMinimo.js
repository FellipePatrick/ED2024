...
class FilaPrioridade {
	...
	Se a prioridade do pai for maior que filho, coloque o pai na posição do filho.
	Repita as etapas 3 e 4 até que a prioridade do pai seja menor ou igual ao filho.	*/
	...
	Se o valor do pai for maior que filho, troque-os.
	Repita as etapas 3 e 4 até que a prioridade do pai seja menor ou igual ao filho.
	*/
	remove() {
		let elemento_menor_prioridade = this.tree[1];
		...
		return elemento_menor_prioridade;
	}
